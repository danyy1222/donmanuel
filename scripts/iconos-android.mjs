...
const bolsa = `
  ...
  <path d="M256 232c34 0 54 22 54 50s-24 46-54 46-54-18-54-46 20-50 54-50z" fill="${VERDE}"/>
  <path d="M256 232c-6-18-2-32 10-42 6 14 4 30-10 42z" fill="${VERDE}"/>`

const completo = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  <rect width="512" height="512" rx="112" fill="${VERDE}"/>${bolsa}
</svg>`
...
<resources>
    <color name="ic_launcher_background">${VERDE}</color>
</resources>
`,
)
